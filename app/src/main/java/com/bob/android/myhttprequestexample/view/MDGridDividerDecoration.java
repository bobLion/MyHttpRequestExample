...
/**
 * @package com.bob.android.myhttprequestexample.view
 * @fileName MDGridDividerDecoration
 * @Author Bob on 2019/2/22 14:03.
 * @Describe TODO
 */
public class MDGridDividerDecoration extends RecyclerView.ItemDecoration {

    private static final int[] ATTRS = new int[]{android.R.attr.listDivider};
    private Drawable mDivider;

    public MDGridDividerDecoration(Context context){
